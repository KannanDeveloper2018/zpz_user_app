        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        allData = { user_id: localStorage.getItem('user_id'), lat: this.map.center.lat(), lng: this.map.center.lng(), address: data.address, landmark: data.landmark };
                        this.server.saveAddress(allData).subscribe(function (response) {
                            var navigationExtras = {
                                queryParams: (data.landmark) ? { address: data.address + " - " + data.landmark } : { address: data.address }
                            };
                            _this.nav.navigateBack('/checkout', navigationExtras);
                            loading.dismiss();
                        });
                        return [2 /*return*/];
                }
